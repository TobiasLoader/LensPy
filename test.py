...
# print('tobblit4 profile id: ',lp.get_profile_id('tobblit4'))
# print(lp.address_profiles('0xF1fdbAc76120afE92AF99b4ab1776300ea9b6Ea3'))
# print(lp.search_profiles('tobblit'))
...
print('who Im following: ', lp.following_by_id(pub))
